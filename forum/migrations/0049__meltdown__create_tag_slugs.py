...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.add_column('forum_tag', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        for tag in orm.Tag.objects.all():
            tag.slug = slugify(unidecode(smart_unicode(tag.name)))
            tag.save()

        db.alter_column('forum_tag', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))
        db.create_unique('forum_tag', 'slug')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 13, 11, 24, 41, 799575)'}),
        ...
        'forum.tag': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '255', 'blank': 'True'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 14, 11, 24, 41, 857172)'}),
